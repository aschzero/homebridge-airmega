...
*/
export var AesUtil = AesUtil || function (t, e) { this.keyItSize = t / 32, this.iterationKeyCount = e; };
AesUtil.prototype.encodeString = function (t, e, n) { return e + ":" + n + ":" + id; }, AesUtil.encrypt = function (t, e, n) { var i, r, o, c = CryptoJS.AES.encrypt(e, n, { iv: t }); return i = t.toString(CryptoJS.enc.Base64), r = c, o = n.toString(CryptoJS.enc.Base64), i + ":" + r.ciphertext.toString() + ":" + o; };
